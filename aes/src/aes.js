...
function mixColumns(state) {
  for (let column = 0; column < numColumns; column++) {
    ...
    state[0][column] = mul(2, a) ^ mul(3, b) ^ mul(1, c) ^ mul(1, d);
    state[1][column] = mul(1, a) ^ mul(2, b) ^ mul(3, c) ^ mul(1, d);
    state[2][column] = mul(1, a) ^ mul(1, b) ^ mul(2, c) ^ mul(3, d);
    state[3][column] = mul(3, a) ^ mul(1, b) ^ mul(1, c) ^ mul(2, d);
  }
}
...
function invMixColumns(state) {
  for (let column = 0; column < numColumns; column++) {
    ...
    state[0][column] = mul(14, a) ^ mul(11, b) ^ mul(13, c) ^ mul(9, d);
    state[1][column] = mul(9, a) ^ mul(14, b) ^ mul(11, c) ^ mul(13, d);
    state[2][column] = mul(13, a) ^ mul(9, b) ^ mul(14, c) ^ mul(11, d);
    state[3][column] = mul(11, a) ^ mul(13, b) ^ mul(9, c) ^ mul(14, d);
  }
}
